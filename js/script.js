...
Volume = content.querySelector(".volume");
Volumebar = content.querySelector(".volumebar");
Volumedot = content.querySelector(".dot");
...
function loadData(indexValue){
  ...
  document.body.style.backgroundImage = `url('images/${songs[indexValue - 1].img}.jpg')`;
...
//i have no fucking idea how to make this shit work1!!!


let volume = 0.5;

function updateVolume() {
  const maxWidth = Volumebar.clientWidth;
  const dotPosition = Volumedot.offsetLeft;
  volume = dotPosition / maxWidth;
